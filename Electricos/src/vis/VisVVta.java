...
public class VisVVta extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisVVta.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sColOri         = jTab.getValueAt(jTab.getSelectedRow(), 14).toString();
                        ...
                        sEntreOri       = jTab.getValueAt(jTab.getSelectedRow(), 19).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sEsKitOri,      jTab.getSelectedRow(), 12);                        
                        jTab.setValueAt(sTallOri,       jTab.getSelectedRow(), 13);                        
                        jTab.setValueAt(sColOri,        jTab.getSelectedRow(), 14);                        
