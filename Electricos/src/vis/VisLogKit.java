...
public class VisLogKit extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisLogKit.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sAcciOri        = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sAcciOri,       jTab.getSelectedRow(), 4);                                                
