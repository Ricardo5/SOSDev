...
public class VisCxc1 extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisCxc1.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sEmpOri         = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sEmpOri,        jTab.getSelectedRow(), 3);                        
                        ...
                        jTab.setValueAt(sTotAbonsOri,   jTab.getSelectedRow(), 6);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Folio", "Serie", "Cliente", "Nombre", "Importe", "Impuesto", "Total", "Total Abonos", "Pendiente Liquidar", "Fecha", "Fecha Vencimiento", "Sucursal", "Caja", "Usuario", "Nombre Usuario", "Estado", "id"
            }
        ) {
