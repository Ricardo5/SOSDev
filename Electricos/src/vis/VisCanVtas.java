...
public class VisCanVtas extends javax.swing.JFrame 
{
    ...
    {                          
        ...
        setExtendedState(getExtendedState() | VisCanVtas.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sNomEmpOri          = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                        sTotOri             = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sNomEmpOri,         jTab.getSelectedRow(), 3);                        
                        jTab.setValueAt(sTotOri,            jTab.getSelectedRow(), 4);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Tipo Documento", "Venta", "Serie Venta", "Folio", "Nombre Cliente", "Total", "Fecha", "Sucursal", "No. Caja", "Usuario", "Nombre Usuario"
            }
        ) {
