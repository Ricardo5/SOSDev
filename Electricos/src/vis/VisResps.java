...
public class VisResps extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisResps.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sHrsOri         = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sHrsOri,       jTab.getSelectedRow(), 2);                        
