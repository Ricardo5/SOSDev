...
public class VisContras1 extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisContras1.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sFVencOri       = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        ...
                        sNomOri         = jTab.getValueAt(jTab.getSelectedRow(), 12).toString();
                        sContraOri      = jTab.getValueAt(jTab.getSelectedRow(), 13).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sFVencOri,          jTab.getSelectedRow(), 6);                        
                        ...
                        jTab.setValueAt(sContraOri,         jTab.getSelectedRow(), 6);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Compra", "Proveedor", "Nombre", "Importe", "Impuesto", "Total", "Fecha", "Fecha Vencimiento", "Sucursal", "Caja", "Usuario", "Nombre Usuario", "Contrarecibo"
            }
        ) {
