...
public class VisTraspas extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisTraspas.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCantSalOri     = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                        sAlma2Ori       = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                        sCantEntOri     = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sFechTOri       = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCantSalOri,    jTab.getSelectedRow(), 4);                        
                        jTab.setValueAt(sAlma2Ori,      jTab.getSelectedRow(), 5);                        
                        jTab.setValueAt(sCantEntOri,    jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sFechTOri,      jTab.getSelectedRow(), 7);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Producto", "Cod. Almacén", "Cod. Concepto", "Cant. Saliente", "Cod. Almacén", "Cant. Entrante", "Fecha Traspaso", "Sucursal", "Caja", "Usuario", "Nombre Usuario"
            }
        ) {
