...
public class VisAProyCara extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisAProyCara.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sNomEmpOri     = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                        sObservOri     = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                        ...
                        sUltModOri     = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                        sSucOri        = jTab.getValueAt(jTab.getSelectedRow(), 10).toString();
                        sCajOri        = jTab.getValueAt(jTab.getSelectedRow(), 11).toString();
                        sEstacOri      = jTab.getValueAt(jTab.getSelectedRow(), 12).toString();
                        sEstacNomOri   = jTab.getValueAt(jTab.getSelectedRow(), 13).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sNomEmpOri,    jTab.getSelectedRow(), 4);                        
                        jTab.setValueAt(sObservOri,    jTab.getSelectedRow(), 5);                        
                        ...
                        jTab.setValueAt(sUltModOri,    jTab.getSelectedRow(), 9);                        
                        jTab.setValueAt(sSucOri,       jTab.getSelectedRow(), 10);                        
                        jTab.setValueAt(sCajOri,       jTab.getSelectedRow(), 11);                        
                        jTab.setValueAt(sEstacOri,     jTab.getSelectedRow(), 12);                        
                        jTab.setValueAt(sEstacNomOri,  jTab.getSelectedRow(), 13);                        
                        jTab.setValueAt(sCodOri,       jTab.getSelectedRow(), 14);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Cotización", "Serie", "Cliente", "Nombre ", "Observaciones", "Descripción", "Importe", "Fecha de Creación", "Última Modificación", "Sucursal", "Caja", "Usuario", "Nombre Usuario"
            }
        ));
