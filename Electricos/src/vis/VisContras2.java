...
public class VisContras2 extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisContras2.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sFecgOri            = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        sFVencOri           = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        sEstacOri           = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                        sContraOri          = jTab.getValueAt(jTab.getSelectedRow(), 10).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sFecgOri,       jTab.getSelectedRow(), 7);                        
                        jTab.setValueAt(sFVencOri,      jTab.getSelectedRow(), 8);                        
                        jTab.setValueAt(sEstacOri,      jTab.getSelectedRow(), 9);                        
                        jTab.setValueAt(sContraOri,     jTab.getSelectedRow(), 10);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Compra", "Proveedor", "Nombre", "Importe", "Impuesto", "Total", "Fecha", "Fecha Vencimiento", "Usuario", "Contrarecibo"
            }
        ) {
