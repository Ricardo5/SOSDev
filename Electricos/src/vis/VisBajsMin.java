...
public class VisBajsMin extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisBajsMin.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCodOp1Ori      = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                        sCodOp2Ori      = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                        ...
                        sExisOri        = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        sMinOri         = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                        sMaxOri         = jTab.getValueAt(jTab.getSelectedRow(), 10).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCodOp1Ori,    jTab.getSelectedRow(), 2);                        
                        jTab.setValueAt(sCodOp2Ori,    jTab.getSelectedRow(), 3);                        
                        ...
                        jTab.setValueAt(sExisOri,      jTab.getSelectedRow(), 8);                        
                        jTab.setValueAt(sMinOri,       jTab.getSelectedRow(), 9);                        
                        jTab.setValueAt(sMaxOri,       jTab.getSelectedRow(), 10);                        
