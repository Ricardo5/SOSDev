...
public class VisCotsJPS2 extends javax.swing.JFrame 
{
    ...
    private String  sSubTotGralOri;
    private String  sManObrOri;    
    private String  sSubTotMatOri;
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisCotsJPS2.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sSubTotGralOri  = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                        sManObrOri      = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sSubTotMatOri   = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        sDescripOri     = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        sFCreaOri       = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                        sFModOri        = jTab.getValueAt(jTab.getSelectedRow(), 10).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sSubTotGralOri, jTab.getSelectedRow(), 5);                        
                        jTab.setValueAt(sManObrOri,     jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sSubTotMatOri,  jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sDescripOri,    jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sFCreaOri,      jTab.getSelectedRow(), 6);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Cotización", "Cod. Proyecto", "Nombre Cliente", "Observaciones", "Subtotal General", "Mano de Obra", "Subtotal Materiales", "Descripción", "Fecha Creación", "Fecha Modificación", "Usuario"
            }
        ) {
