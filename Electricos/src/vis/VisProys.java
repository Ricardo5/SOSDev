...
public class VisProys extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisProys.MAXIMIZED_BOTH);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Proyecto", "Nombre Cliente", "Importe", "Fecha de Creación", "Última Modificación", "Estado", "Sucursal", "Caja", "Usuario", "Nombre Usuario"
            }
        ) {
