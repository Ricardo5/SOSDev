...
public class VisImpres extends javax.swing.JFrame 
{
    ...
    private String  sImpFOri;
    private String  sImpTOri;
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisImpres.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sImpFOri        = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                        sImpTOri        = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sImpFOri,       jTab.getSelectedRow(), 2);                        
                        jTab.setValueAt(sImpTOri,       jTab.getSelectedRow(), 3);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Estación", "Impresora Facturas", "Impresora Tickets", "52mm", "Corte"
            }
        ) {
