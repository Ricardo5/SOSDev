...
public class VisNewFac extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisNewFac.MAXIMIZED_BOTH);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Producto", "Qty.", "Unidad", "Almacèn", "Lista", "Descripción", "Precio", "Descuento", "Impuesto", "Importe", "Es Kit", "Total Impuesto", "Talla", "Color", "Lote", "Pedimento", "Caducidad", "ID", "Backorder", "Importe Descuento", "Serie Producto", "Comentario Serie", "Garantía", "cantlotori", "Costo", "Cod.Impuesto"
            }
        ) {
