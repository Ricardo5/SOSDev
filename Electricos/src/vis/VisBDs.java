...
public class VisBDs extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisBDs.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCodEmpOri          = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();
                        sNomEmpOri          = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                        sServOri            = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                        sUsrOri             = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                        sContraOri          = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                        sBDOri              = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sFCreaOri           = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        sUltModOri          = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCodEmpOri,         jTab.getSelectedRow(), 1);                        
                        jTab.setValueAt(sNomEmpOri,         jTab.getSelectedRow(), 2);                        
                        jTab.setValueAt(sServOri,           jTab.getSelectedRow(), 3);                        
                        jTab.setValueAt(sUsrOri,            jTab.getSelectedRow(), 4);                        
                        jTab.setValueAt(sContraOri,         jTab.getSelectedRow(), 5);
                        jTab.setValueAt(sBDOri,             jTab.getSelectedRow(), 6);
                        jTab.setValueAt(sFCreaOri,          jTab.getSelectedRow(), 7);
                        jTab.setValueAt(sUltModOri,         jTab.getSelectedRow(), 8);
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Cod. Cliente", "Nombre", "Servidor", "Usuario", "Contrasenia", "BD", "F. Creación", "F.Última Modificación", "Sucursal", "Caja", "Usuario", "Nombre Usuario"
            }
        ) {
