...
public class VisAOrd extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisAOrd.MAXIMIZED_BOTH);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            boolean[] canEdit = new boolean [] {
                false, true, true, true, true, true, true, true, true, true, false, false, true, true, true
            };
