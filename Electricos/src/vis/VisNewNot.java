...
public class VisNewNot extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisNewNot.MAXIMIZED_BOTH);                        
        ...
        jTab.getColumnModel().getColumn(1).setPreferredWidth(30);
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sDescripOri     = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();
                        sOtrOri         = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sDescripOri,    jTab.getSelectedRow(), 1);                        
                        jTab.setValueAt(sOtrOri,        jTab.getSelectedRow(), 2);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Qty.", "Folio", "Serie", "Cliente", "Nombne", "Descripción", "Importe"
            }
        ) {
