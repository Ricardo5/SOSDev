...
public class VisResp extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisResp.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sImpueValOri   = jTab.getValueAt(jTab.getSelectedRow(), 11).toString();
                        sUltCostOri    = jTab.getValueAt(jTab.getSelectedRow(), 12).toString();
                        sCodOri        = jTab.getValueAt(jTab.getSelectedRow(), 13).toString();
                        sImpoOri       = jTab.getValueAt(jTab.getSelectedRow(), 14).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sImpueValOri,  jTab.getSelectedRow(), 11);                        
                        jTab.setValueAt(sUltCostOri,   jTab.getSelectedRow(), 12);                        
                        jTab.setValueAt(sCodOri,       jTab.getSelectedRow(), 13);                        
                        jTab.setValueAt(sImpoOri,      jTab.getSelectedRow(), 14);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Tipo", "Respuesta", "MySQLDe", "MySQLA", "Arcvhivos De", "Arcvhivos A", "Fecha", "Error", "Sucursal", "Caja", "Usuario", "Nombre de Usuario"
            }
        ) {
