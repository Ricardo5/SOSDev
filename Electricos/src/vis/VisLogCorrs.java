...
public class VisLogCorrs extends javax.swing.JFrame 
{
    /*Contador para modificar tabla*/
    private int     iContCellEd;
    
    /*Declara variables originales*/
    private String  sDOri;
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisLogCorrs.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sDOri           = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sDOri,          jTab.getSelectedRow(), 1);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "De", "A", "No Documento", "Tipo Documento", "Estado", "Motivo", "Fecha Alta", "Sucursal", "No.Caja", "Usuario", "Nombre Usuario"
            }
        ) {
