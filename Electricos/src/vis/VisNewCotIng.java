...
public class VisNewCotIng extends javax.swing.JFrame 
{
    ...
    private String  sImpueImpueOri;
    private String  sImpueImpue2Ori;
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisNewCotIng.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sPre2Ori        = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sImpoOri        = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        sImpo2Ori       = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        ...
                        sAlmaOri        = jTab.getValueAt(jTab.getSelectedRow(), 14).toString();
                        sMonOri         = jTab.getValueAt(jTab.getSelectedRow(), 15).toString();
                        sImpueOri       = jTab.getValueAt(jTab.getSelectedRow(), 16).toString();
                        sImpueImpueOri  = jTab.getValueAt(jTab.getSelectedRow(), 17).toString();
                        sImpueImpue2Ori = jTab.getValueAt(jTab.getSelectedRow(), 18).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sPre2Ori,       jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sImpoOri,       jTab.getSelectedRow(), 7);                        
                        jTab.setValueAt(sImpo2Ori,      jTab.getSelectedRow(), 8);                        
                        ...
                        jTab.setValueAt(sImpueImpueOri, jTab.getSelectedRow(), 17);                        
                        jTab.setValueAt(sImpueImpue2Ori,jTab.getSelectedRow(), 18);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Qty", "Unidad", "Producto", "Descripción", "Precio", "Precio JPS2", "Importe", "Importe JPS2", "D1", "D2", "D3", "D4", "D5", "Almacén", "Moneda", "%Impuesto", "Total Impuesto", "Total Impuesto JPS2", "Serie Producto", "Comentario Serie", "Garantía"
            }
        ) {
