...
public class VisBusc2 extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisBusc2.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sExisOri       = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sExisOri,           jTab.getSelectedRow(), 3);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod.", "Descripción", "Cod. Almacén", "Existencia"
            }
        ) {
