...
public class VisUltPrecs extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisUltPrecs.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sTipoDocOri     = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sTipoDocOri,    jTab.getSelectedRow(), 3);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Folio", "Serie", "Tipo Documento", "Precio", "Fecha"
            }
        ) {
