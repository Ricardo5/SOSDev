...
public class VisSerGral extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisSerGral.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sSerOri         = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();
                        sDescripOri     = jTab.getValueAt(jTab.getSelectedRow(), 2).toString();
                        sConsecOri      = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sSerOri,        jTab.getSelectedRow(), 1);                        
                        jTab.setValueAt(sDescripOri,    jTab.getSelectedRow(), 2);                        
                        jTab.setValueAt(sConsecOri,     jTab.getSelectedRow(), 3);                        
