...
public class VisNewCotNorm extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisNewCotNorm.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sImpoOri        = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sD1Ori          = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        sD2Ori          = jTab.getValueAt(jTab.getSelectedRow(), 8).toString();
                        sD3Ori          = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                        sD4Ori          = jTab.getValueAt(jTab.getSelectedRow(), 10).toString();
                        sD5Ori          = jTab.getValueAt(jTab.getSelectedRow(), 11).toString();
                        sAlmaOri        = jTab.getValueAt(jTab.getSelectedRow(), 12).toString();
                        sMonOri         = jTab.getValueAt(jTab.getSelectedRow(), 13).toString();
                        sImpueOri       = jTab.getValueAt(jTab.getSelectedRow(), 14).toString();
                        sImpoImpueOri   = jTab.getValueAt(jTab.getSelectedRow(), 15).toString();
                        sSerProdOri     = jTab.getValueAt(jTab.getSelectedRow(), 16).toString();
                        sComenSerOri    = jTab.getValueAt(jTab.getSelectedRow(), 17).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sD1Ori,         jTab.getSelectedRow(), 7);                        
                        jTab.setValueAt(sD2Ori,         jTab.getSelectedRow(), 8);                        
                        jTab.setValueAt(sD3Ori,         jTab.getSelectedRow(), 9);                        
                        jTab.setValueAt(sD4Ori,         jTab.getSelectedRow(), 10);                        
                        jTab.setValueAt(sD5Ori,         jTab.getSelectedRow(), 11);                        
                        jTab.setValueAt(sAlmaOri,       jTab.getSelectedRow(), 12);                        
                        jTab.setValueAt(sMonOri,        jTab.getSelectedRow(), 13);                        
                        jTab.setValueAt(sImpueOri,      jTab.getSelectedRow(), 14);                        
                        jTab.setValueAt(sImpoImpueOri,  jTab.getSelectedRow(), 15);                        
                        jTab.setValueAt(sSerProdOri,    jTab.getSelectedRow(), 16);
                        jTab.setValueAt(sComenSerOri,   jTab.getSelectedRow(), 17);
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Qty.", "Unidad", "Producto", "Descripción", "Precio", "Importe", "D1", "D2", "D3", "D4", "D5", "Almacén", "Moneda", "%Impuesto", "Total Impuesto", "Serie Producto", "Comentario Serie"
            }
        ) {
