...
public class VisIngrInvent extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisIngrInvent.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sFIngreOri      = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sFIngreOri,     jTab.getSelectedRow(), 5);                        
