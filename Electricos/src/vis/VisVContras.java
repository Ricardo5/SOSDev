...
public class VisVContras extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisVContras.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCompOri        = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCompOri,           jTab.getSelectedRow(), 4);                        
