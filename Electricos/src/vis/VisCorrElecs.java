...
public class VisCorrElecs extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisCorrElecs.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCorrOri        = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                        sCorrAlterOri   = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCorrOri,       jTab.getSelectedRow(), 3);                        
                        jTab.setValueAt(sCorrAlterOri,  jTab.getSelectedRow(), 4);                        
