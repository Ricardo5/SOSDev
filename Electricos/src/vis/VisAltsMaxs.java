...
/*Clase para controlar el visor de tabla*/
public class VisAltsMaxs extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisAltsMaxs.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sExisOri        = jTab.getValueAt(jTab.getSelectedRow(), 9).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sExisOri,      jTab.getSelectedRow(), 9);                        
