...
public class VisACotNorm extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisACotNorm.MAXIMIZED_BOTH);                        
        ...
        jTab.getColumnModel().getColumn(13).setPreferredWidth(150);
        jTab.getColumnModel().getColumn(14).setPreferredWidth(150);
        jTab.getColumnModel().getColumn(15).setPreferredWidth(150);
        jTab.getColumnModel().getColumn(16).setPreferredWidth(150);
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sListOri        = jTab.getValueAt(jTab.getSelectedRow(), 4).toString();
                        ...
                        sColoOri        = jTab.getValueAt(jTab.getSelectedRow(), 18).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sListOri,       jTab.getSelectedRow(), 4);
                        ...
                        jTab.setValueAt(sColoOri,       jTab.getSelectedRow(), 18);
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Qty", "Producto", "Unidad", "Lista", "Descripción", "Precio", "Desc.%", "Almacén", "Importe", "%Impuesto", "Total Impuesto", "Importe Descuento", "Serie Producto", "Comentario Serie", "Garantía", "Es Kit", "Talla", "Color", "Back Order", "Lote", "Pedimento", "Caducidad", "Cod.Impue"
            }
        ) {
