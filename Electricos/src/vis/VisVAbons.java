...
public class VisVAbons extends javax.swing.JFrame 
{
    /*Contador para modificar tabla*/
    private int     iContCellEd;
    
    /*Declara variables originales*/
    private String  sFolConseOri;
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisVAbons.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sFolConseOri    = jTab.getValueAt(jTab.getSelectedRow(), 0).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sFolConseOri,   jTab.getSelectedRow(), 0);                        
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Folio Consecutivo", "Folio Venta", "Fecha", "Importe", "Sucursal", "Caja", "Usuario"
            }
        ));
