...
public class VisPtoVtaTou extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisPtoVtaTou.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sDescOri            = jTab.getValueAt(jTab.getSelectedRow(), 3).toString();
                        ...
                        sValImpueOri        = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sDescOri,           jTab.getSelectedRow(), 3);                        
                        ...
                        jTab.setValueAt(sValImpueOri,       jTab.getSelectedRow(), 7);                        
    ...
    private void initComponents() {
        ...
        jTab.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Qty.", "Cod. Artículo", "Descripción", "Desc.", "Precio", "Importe", "Impuesto", "Valor Imp.", "Almacén"
            }
        ) {
