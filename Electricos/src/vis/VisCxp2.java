...
public class VisCxp2 extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisCxp2.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sFechOri        = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();
                        ...
                        sDescripOri     = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        ...
                        sPreOri         = jTab.getValueAt(jTab.getSelectedRow(), 11).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sFechOri,       jTab.getSelectedRow(), 1);                        
                        ...
                        jTab.setValueAt(sMonOri,        jTab.getSelectedRow(), 6);                        
