...
public class VisImprVtas extends javax.swing.JFrame 
{
    ...
    {                
        ...
        setExtendedState(getExtendedState() | VisImprVtas.MAXIMIZED_BOTH);                        
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCodEmpOri     = jTab.getValueAt(jTab.getSelectedRow(), 5).toString();
                        sSerOri        = jTab.getValueAt(jTab.getSelectedRow(), 6).toString();
                        sNomEmpOri     = jTab.getValueAt(jTab.getSelectedRow(), 7).toString();
                        ...
                        sEstadOri      = jTab.getValueAt(jTab.getSelectedRow(), 11).toString();
                        sSucOri        = jTab.getValueAt(jTab.getSelectedRow(), 12).toString();
                        sCajOri        = jTab.getValueAt(jTab.getSelectedRow(), 13).toString();
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCodEmpOri,     jTab.getSelectedRow(), 5);                        
                        jTab.setValueAt(sSerOri,        jTab.getSelectedRow(), 6);                        
                        jTab.setValueAt(sNomEmpOri,     jTab.getSelectedRow(), 6);
                        jTab.setValueAt(sTotOri,        jTab.getSelectedRow(), 6);
                        jTab.setValueAt(sFechOri,       jTab.getSelectedRow(), 6);
                        ...
                        jTab.setValueAt(sNomEstacOri,   jTab.getSelectedRow(), 6);
    ...
    private void initComponents() {
        ...
        jTab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Tipo Documento", "Venta", "Serie", "Folio", "Cod.Cliente", "Serie Cliente", "Nombre Cliente", "Total", "Fecha", "Corte", "Estado", "Sucursal", "No.Caja", "Usuario", "Nombre Usuario"
            }
        ) {
