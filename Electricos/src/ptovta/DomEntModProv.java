...
public class DomEntModProv extends javax.swing.JFrame 
{
    ...
    public DomEntModProv(Prov modP) 
    {
        ...
        jTTel.setText       (modProv.sTelEn);
        jTLada.setText      (modProv.sLadaEn);        
        jTExten.setText     (modProv.sNoExtEn);                          
        jTCel.setText       (modProv.sCelEn);                                  
        jTTelPer1.setText   (modProv.sTelPer1En);                                          
        jTTelPers2.setText  (modProv.sTelPer2En);                                                  
        jTCall.setText      (modProv.sCallEn);                                                          
        jTCol.setText       (modProv.sColEn);        
        jTNoExt.setText     (modProv.sExtEn);        
        jTNoInt.setText     (modProv.sIntEn);
        jTCP.setText        (modProv.sCPEn);        
        jTCiu.setText       (modProv.sCiuEn);                
        jTEstad.setText     (modProv.sEstadEn);                        
        jTPai.setText       (modProv.sPaiEn);                        
        jTCo1.setText       (modProv.sCo1En);                        
        jTCo2.setText       (modProv.sCo2En);                        
        jTCo3.setText       (modProv.sCo3En);                        
    ...
    private void initComponents() {
        ...
        jP1.add(jBGuar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 110, 30));
        ...
        jP1.add(jBSal, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, 110, 30));
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        modProv.sTelEn       = jTTel.getText();
        modProv.sLadaEn      = jTLada.getText();
        modProv.sExtEn       = jTExten.getText();
        modProv.sCelEn       = jTCel.getText();
        modProv.sTelPer1En   = jTTelPer1.getText();
        modProv.sTelPer2En   = jTTelPers2.getText();
        modProv.sCallEn      = jTCall.getText();
        modProv.sColEn       = jTCol.getText();
        modProv.sNoExtEn     = jTNoExt.getText();
        modProv.sIntEn       = jTNoInt.getText();
        modProv.sCPEn        = jTCP.getText();
        modProv.sCiuEn       = jTCiu.getText();
        modProv.sEstadEn     = jTEstad.getText();
        modProv.sPaiEn       = jTPai.getText();
        modProv.sCo1En       = jTCo1.getText();
        modProv.sCo2En       = jTCo2.getText();
        modProv.sCo3En       = jTCo3.getText();
    ...
    /*Cuando se pierde el foco del teclado en el campo de lada*/
    ...
    /*Cuando se pierde el foco del teclado en el campo de la extensión*/
