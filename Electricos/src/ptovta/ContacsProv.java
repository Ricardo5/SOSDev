...
/*Clase para controlar los Contactos de los proveedores nuevos*/
public class ContacsProv extends javax.swing.JFrame 
{
    /*Contiene el color original del botón*/
    private final java.awt.Color            colOri;
    
    /*Contiene la referencia del otro formualario para poder tener acceso a sus variables*/
    private final Prov                   newProv;
    
    
    
    /*Constructor sin argumentos*/
    public ContacsProv(Prov newP) 
    {
        ...
        this.setTitle("Contactos de Proveedores, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
        ...
        jTCon3.setText(newProv.sContac3);
        jTCon4.setText(newProv.sContac4);
        jTCon5.setText(newProv.sContac5);
        jTCon6.setText(newProv.sContac6);
        jTCon7.setText(newProv.sContac7);
        jTCon8.setText(newProv.sContac8);
        jTCon9.setText(newProv.sContac9);
        jTCon10.setText(newProv.sContac10);
        
        /*Carga los teléfonos del otro formulario*/
        jTTel3.setText(newProv.sTelCon3);
        jTTel4.setText(newProv.sTelCon4);
        jTTel5.setText(newProv.sTelCon5);
        jTTel6.setText(newProv.sTelCon6);
        jTTel7.setText(newProv.sTelCon7);
        jTTel8.setText(newProv.sTelCon8);
        jTTel9.setText(newProv.sTelCon9);
        jTTel10.setText(newProv.sTelCon10);
        
        /*Carga los teléfonos personales del otro formulario*/
        jTTelPer3.setText(newProv.sTelPer3);
        jTTelPer4.setText(newProv.sTelPer4);
        jTTelPer5.setText(newProv.sTelPer5);
        jTTelPer6.setText(newProv.sTelPer6);
        jTTelPer7.setText(newProv.sTelPer7);
        jTTelPer8.setText(newProv.sTelPer8);
        jTTelPer9.setText(newProv.sTelPer9);
        jTTelPer10.setText(newProv.sTelPer10);
        
        /*Carga los teléfonos personales del otro forumario segunda parte*/
        jTTelPer23.setText(newProv.sTelPer33);
        jTTelPer24.setText(newProv.sTelPer44);
        jTTelPer25.setText(newProv.sTelPer55);
        jTTelPer26.setText(newProv.sTelPer66);
        jTTelPer27.setText(newProv.sTelPer77);
        jTTelPer28.setText(newProv.sTelPer88);
        jTTelPer29.setText(newProv.sTelPer99);
        jTTelPer30.setText(newProv.sTelPer100);        
        
    }/*Fin de public ContacsEmp() */        
    ...
    private void initComponents() {
        ...
        jP1.add(jBSal, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 340, 120, 30));
        ...
        jP1.add(jBGuar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 340, 120, 30));
        ...
        jP1.add(jLAyu, new org.netbeans.lib.awtextra.AbsoluteConstraints(346, 380, 230, 20));
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        newProv.sContac3 = jTCon3.getText();        
        newProv.sContac4 = jTCon4.getText();
        newProv.sContac5 = jTCon5.getText();
        newProv.sContac6 = jTCon6.getText();
        newProv.sContac7 = jTCon7.getText();
        newProv.sContac8 = jTCon8.getText();
        newProv.sContac9 = jTCon9.getText();
        newProv.sContac10= jTCon10.getText();
        
        /*Lee los teléfonos que introdujo el usuario*/
        newProv.sTelCon3 = jTTel3.getText();
        newProv.sTelCon4 = jTTel4.getText();
        newProv.sTelCon5 = jTTel5.getText();
        newProv.sTelCon6 = jTTel6.getText();
        newProv.sTelCon7 = jTTel7.getText();
        newProv.sTelCon8 = jTTel8.getText();
        newProv.sTelCon9 = jTTel9.getText();
        newProv.sTelCon10= jTTel10.getText();
    
        /*Lee los teléfonos personales que introdujo el usuario perimera parte*/
        newProv.sTelPer3 = jTTelPer3.getText();
        newProv.sTelPer4 = jTTelPer4.getText();
        newProv.sTelPer5 = jTTelPer5.getText();
        newProv.sTelPer6 = jTTelPer6.getText();
        newProv.sTelPer7 = jTTelPer7.getText();
        newProv.sTelPer8 = jTTelPer8.getText();
        newProv.sTelPer9 = jTTelPer9.getText();
        newProv.sTelPer10= jTTelPer10.getText();
        
        /*Lee los teléfonos personales que introdujo el usuario segunda parte*/
        newProv.sTelPer33= jTTelPer23.getText();
        newProv.sTelPer44= jTTelPer24.getText();
        newProv.sTelPer55= jTTelPer25.getText();
        newProv.sTelPer66= jTTelPer26.getText();
        newProv.sTelPer77= jTTelPer27.getText();
        newProv.sTelPer88= jTTelPer28.getText();
        newProv.sTelPer99= jTTelPer29.getText();
        newProv.sTelPer100= jTTelPer30.getText();
    ...
    private void jTTel10KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTTel10KeyTyped
        // TODO add your handling code here:
         if(((evt.getKeyChar() < '0') || (evt.getKeyChar() > '9')) && (evt.getKeyChar() != '\b') && (evt.getKeyChar() != '.'))         
            evt.consume(); if(((evt.getKeyChar() < '0') || (evt.getKeyChar() > '9')) && (evt.getKeyChar() != '\b') && (evt.getKeyChar() != '.'))         
            evt.consume();
