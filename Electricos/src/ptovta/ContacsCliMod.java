...
/*Clase para controlar los Contactos de la empresa en la parte de la modificación*/
public class ContacsCliMod extends javax.swing.JFrame 
{
    /*Contiene el color original del botón*/
    private final java.awt.Color            colOri;
    
    /*Contiene la referencia del otro formulario para poder acceder a las variables*/
    private final Client                    modCli;
    
    
    
    /*Constructor sin argumentos*/
    public ContacsCliMod(Client modCl) 
    {
        /*Inicaliza los componentes gráficos*/
        initComponents();
        
        /*Obtiene la referencia del otro formulario para poder acceder a las variables*/
        modCli  = modCl;
        ...
        jTCon3.setText(modCli.sContac3);
        jTCon4.setText(modCli.sContac4);
        jTCon5.setText(modCli.sContac5);
        jTCon6.setText(modCli.sContac6);
        jTCon7.setText(modCli.sContac7);
        jTCon8.setText(modCli.sContac8);
        jTCon9.setText(modCli.sContac9);
        jTCon10.setText(modCli.sContac10);
        
        /*Carga los teléfonos del otro formulario*/
        jTTel3.setText(modCli.sTelCon3);
        jTTel4.setText(modCli.sTelCon4);
        jTTel5.setText(modCli.sTelCon5);
        jTTel6.setText(modCli.sTelCon6);
        jTTel7.setText(modCli.sTelCon7);
        jTTel8.setText(modCli.sTelCon8);
        jTTel9.setText(modCli.sTelCon9);
        jTTel10.setText(modCli.sTelCon10);
        
        /*Carga los teléfonos personales del otro formulario*/
        jTTelPer3.setText(modCli.sTelPer3);
        jTTelPer4.setText(modCli.sTelPer4);
        jTTelPer5.setText(modCli.sTelPer5);
        jTTelPer6.setText(modCli.sTelPer6);
        jTTelPer7.setText(modCli.sTelPer7);
        jTTelPer8.setText(modCli.sTelPer8);
        jTTelPer9.setText(modCli.sTelPer9);
        jTTelPer10.setText(modCli.sTelPer10);
        
        /*Carga los teléfonos personales del otro forumario segunda parte*/
        jTTelPer23.setText(modCli.sTelPer33);
        jTTelPer24.setText(modCli.sTelPer44);
        jTTelPer25.setText(modCli.sTelPer55);
        jTTelPer26.setText(modCli.sTelPer66);
        jTTelPer27.setText(modCli.sTelPer77);
        jTTelPer28.setText(modCli.sTelPer88);
        jTTelPer29.setText(modCli.sTelPer99);
        jTTelPer30.setText(modCli.sTelPer100);        
    ...
    private void initComponents() {
        ...
        jP1.add(jBSal, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 340, 110, 30));
        ...
        jP1.add(jBGuar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 340, 110, 30));
        ...
        jTTelPer6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 205)));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jP1, javax.swing.GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        modCli.sContac3 = jTCon3.getText();        
        modCli.sContac4 = jTCon4.getText();
        modCli.sContac5 = jTCon5.getText();
        modCli.sContac6 = jTCon6.getText();
        modCli.sContac7 = jTCon7.getText();
        modCli.sContac8 = jTCon8.getText();
        modCli.sContac9 = jTCon9.getText();
        modCli.sContac10= jTCon10.getText();
        
        /*Lee los teléfonos que introdujo el usuario*/
        modCli.sTelCon3 = jTTel3.getText();
        modCli.sTelCon4 = jTTel4.getText();
        modCli.sTelCon5 = jTTel5.getText();
        modCli.sTelCon6 = jTTel6.getText();
        modCli.sTelCon7 = jTTel7.getText();
        modCli.sTelCon8 = jTTel8.getText();
        modCli.sTelCon9 = jTTel9.getText();
        modCli.sTelCon10= jTTel10.getText();
    
        /*Lee los teléfonos personales que introdujo el usuario perimera parte*/
        modCli.sTelPer3 = jTTelPer3.getText();
        modCli.sTelPer4 = jTTelPer4.getText();
        modCli.sTelPer5 = jTTelPer5.getText();
        modCli.sTelPer6 = jTTelPer6.getText();
        modCli.sTelPer7 = jTTelPer7.getText();
        modCli.sTelPer8 = jTTelPer8.getText();
        modCli.sTelPer9 = jTTelPer9.getText();
        modCli.sTelPer10= jTTelPer10.getText();
        
        /*Lee los teléfonos personales que introdujo el usuario segunda parte*/
        modCli.sTelPer33= jTTelPer23.getText();
        modCli.sTelPer44= jTTelPer24.getText();
        modCli.sTelPer55= jTTelPer25.getText();
        modCli.sTelPer66= jTTelPer26.getText();
        modCli.sTelPer77= jTTelPer27.getText();
        modCli.sTelPer88= jTTelPer28.getText();
        modCli.sTelPer99= jTTelPer29.getText();
        modCli.sTelPer100= jTTelPer30.getText();
