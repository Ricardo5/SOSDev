...
/*Clase para ver el domiclio de entrega en la factura*/
public class DomEntCliFac extends javax.swing.JFrame 
{
    ...
    private javax.swing.JTable          jTabO;
    
    /*Contiene el contador de filas*/
    private int                         iContFi;
    
    /*Contiene la dirección del otro formulario*/
    private NewVta                      jFram;
    
    /*Variables originales de la tabla*/
    private String                      sCallOri;
    
    
    
    
    /*Constructor sin argumentos*/
    public DomEntCliFac(javax.swing.JTable jTabOt, NewVta jFra) 
    {
        /*Inicaliza los componentes gráficos*/
        initComponents();
        
        /*Obtiene la direcciónd de la otra forma*/
        jFram   = jFra;
            ...
            public void propertyChange(PropertyChangeEvent event) 
            {
                ...
                if("tableCellEditor".equals(pr)) 
                {
                    ...
                    if(iContCellEd==1)
                    {
                        ...
                        sCallOri        = jTab.getValueAt(jTab.getSelectedRow(), 1).toString();                        
                    ...
                    else
                    {
                        ...
                        jTab.setValueAt(sCallOri, jTab.getSelectedRow(), 1);                        
        ...
        jTab.getSelectionModel().addListSelectionListener(new ListSelectionListener() 
        {
            ...
            {                   
                ...
                jTTel.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 0).toString());
                jTLada.setText      (jTabO.getValueAt(jTab.getSelectedRow(), 1).toString());
                jTExten.setText     (jTabO.getValueAt(jTab.getSelectedRow(), 2).toString());
                jTCel.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 3).toString());
                jTTelPer1.setText   (jTabO.getValueAt(jTab.getSelectedRow(), 4).toString());
                jTTelPers2.setText  (jTabO.getValueAt(jTab.getSelectedRow(), 5).toString());
                jTCall.setText      (jTabO.getValueAt(jTab.getSelectedRow(), 6).toString());
                jTCol.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 7).toString());
                jTNoExt.setText     (jTabO.getValueAt(jTab.getSelectedRow(), 8).toString());
                jTNoInt.setText     (jTabO.getValueAt(jTab.getSelectedRow(), 9).toString());
                jTCP.setText        (jTabO.getValueAt(jTab.getSelectedRow(), 10).toString());
                jTCiu.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 11).toString());
                jTEstad.setText     (jTabO.getValueAt(jTab.getSelectedRow(), 12).toString());
                jTPai.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 13).toString());
                jTCo1.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 14).toString());
                jTCo2.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 15).toString());
                jTCo3.setText       (jTabO.getValueAt(jTab.getSelectedRow(), 16).toString());
            }
        });
        ...
        /*Obtiene la dirección de la tabla del otro formulario*/
        jTabO   = jTabOt;
        ...
        /*Recorre todos los elementos de la tabla de domicilios del otro formulario y agregalos a la tabla actual*/
        for(int x = 0; x < jTabO.getRowCount(); x++)
        {
            /*Agrega la calle de la otra tabla a la tabla actual*/            
            DefaultTableModel te    = (DefaultTableModel)jTab.getModel();
            Object nu[]             = {iContFi, jTabO.getValueAt(x, 6)};
            te.addRow(nu);
    ...
    private void initComponents() {
        ...
        jTab.setName(""); // NOI18N
        jTab.setNextFocusableComponent(jTLada);
        ...
        jP1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 300, 440));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jP1, javax.swing.GroupLayout.PREFERRED_SIZE, 692, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        /*Si no a seleccionado un elemento de la tabla entonces*/
        if(jTab.getSelectedRow()==-1)
        {
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "Selecciona un domicilio de la lista.", "Domicilio de Entrega", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        /*Guarda el índice seleccionado para el otro formulario*/
        jFram.iInd  = jTab.getSelectedRow();
