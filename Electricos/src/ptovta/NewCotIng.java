/*CR01 Creado para JPS Ingenieros 
clase creada para el manejo de cotizaciones de manejo de proyectos
*/
//Paquete
package ptovta;
...
public class NewCotIng extends javax.swing.JDialog
{
    ...
    public NewCotIng (JTable jTabPar, int iContF, String sCod, boolean bVer, String clint,JFrame padre, boolean modal) 
    {   
        super(padre,modal);
    ...
    private void jTProdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTProdKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_DOWN)
        {
            ...
            Busc b = new Busc(null, jTProd.getText(), 2, jTProd, jTDescrip, jTAlma2, "", null);
            b.setVisible(true);
        ...
        else if(evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_B)
        {
            ...
            ptovta.BuscAvan x = new ptovta.BuscAvan(null, jTProd, null, null, null);
            x.setVisible(true);
   ...
   /*Cuando se tipea una tecla en el campo del producto*/ 
    ...
    private void jBCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCliActionPerformed
        ...
        /*Llama al otro formulario de búsqueda y pasale lo que el usr escribió*/
        Busc b = new Busc(null, jTCli.getText(), 1, jTCli, jTNom, jTSer, "", null);
        b.setVisible(true);
    ...
    private void jBListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBListActionPerformed
        ...
        BuscPre b = new BuscPre(null, jTList.getText(), 1, jTList, jTProd.getText());
        b.setVisible(true);
    ...
    private void jTSerProdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTSerProdKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_DOWN)
        {
            ...
            /*Llama al otro formulario de búsqueda y pasale lo que el usuario escribió*/
            Busc b = new Busc(null, jTProd.getText().trim(), 34, jTSerProd, jTComenSer, null, "", null);
            b.setVisible(true);
    ...
    void vKeyPreEsc(java.awt.event.KeyEvent evt)
    {
        ...
        else if(evt.isAltDown() && evt.getKeyCode() == KeyEvent.VK_L  && !bVist)
        {
            ...
            LotPed p = new LotPed(null, jTProd.getText().trim(), jTProd, jTAlma2, jTLot, jTPedimen, jTCadu, jTCantLot, jTId);
            p.setVisible(true);
