...
public class DomEnt extends javax.swing.JFrame 
{
    ...
    /*Contiene la referencia de la tabla del otro formulario para tener acceso a las variables*/
    ...
    public DomEnt(javax.swing.JTable jTabD) 
    {
    ...
    private void initComponents() {
        ...
        jP1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 254, -1, 10));
        ...
        jP1.add(jBAgre, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 430, 100, 20));
        ...
        jP1.add(jBSal, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 390, 120, 30));
        ...
        jP1.add(jBDel, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 430, 100, 20));
    ...
    private void jBAgreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgreActionPerformed
        ...
        DefaultTableModel te    = (DefaultTableModel)jTabDom.getModel();        
        Object nu[]             = {jTTel.getText(), jTLada.getText(), jTExten.getText(), jTCel.getText(), jTTelPer1.getText(), jTTelPer2.getText(), jTCall.getText(), jTCol.getText(), jTNoExt.getText(), jTNoInt.getText(), jTCP.getText(), jTCiu.getText(), jTEstad.getText(), jTPai.getText(), jTCo1.getText(), jTCo2.getText(), jTCo3.getText()};
        te.addRow(nu);
        
        /*Agrega el registro en la tabla local*/
        te                      = (DefaultTableModel)jTab.getModel();        
        Object nu2[]            = {iContFi, jTCall.getText()};
        te.addRow(nu2);
    ...
    void vKeyPreEsc(java.awt.event.KeyEvent evt)
    {
        ...
        /*Si se presiona CTRL + SUP entonces presiona el botón de borrar*/
            ...
            jBDel.doClick();
        /*Si se presiona CTRL + N entonces presiona el botón de guardar*/
