...
public class LPrecsp extends javax.swing.JFrame 
{
    ...
    public LPrecsp(String sProd, String sCodAlma, boolean bActCos, cats.Prods prod) 
    {
    ...
    private void jTPre1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTPre1FocusLost
        ...
        else if(Double.parseDouble(jTCost.getText().replace("$", "").replace(",", ""))<=0)
        {
        ...
        else
        {
            ...
            /*Cálcula la utilidad*/
            String sUtili   = Double.toString(((Double.parseDouble(sPre1) * 100) / Double.parseDouble(sCost))-100);
    ...
    private void jTUti1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTUti1FocusLost
        ...
        /*Cálcula la utilidad*/ 
        sUtil           = Double.toString((Double.parseDouble(sUtil) / 100) * Double.parseDouble(sCost));
        
        /*Cálcula el precio*/
        String sPre1    = Double.toString(Double.parseDouble(sUtil) + Double.parseDouble(sCost));        
