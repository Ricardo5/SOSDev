...
/*Clase para asociar mas Modelos al producto*/
public class ProdModel extends javax.swing.JFrame 
{
    ...
    public ProdModel(Prods pro) 
    {
        ...
        this.setTitle("Asociaciones modelos, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
        ...
        /*Establece el tamaño de las columnas de la tabla de model*/
        ...
        /*Carga los Modelos pasados en el arreglo*/
        vCarg();
        
        /*Inicializa el contador del celleditor*/
        iContCellEd = 1;
                
        /*Crea el listener para la tabla de model, para cuando se modifique una celda*/
    ...
    /*Obtén los Modelos pasados en el arrelgo y cargalos en la tabla*/
    private void vCarg()
    {
        ...
        /*Recorre todo el arreglo de string para obtener el código del Modelo*/
        for(String sMod: prods.sMods)
        {
            /*Obtiene la descripción del Modelo de la base de datos*/
            try
            {
                sQ = "SELECT descrip FROM model WHERE cod = '" + sMod + "'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ASOCIACIONES MODELOS");
        ...
        jLabel2.setText("Descripción del Modelo:");
        ...
        jTCod.setNextFocusableComponent(jBMod);
        ...
        jBMod.setBackground(new java.awt.Color(255, 255, 255));
        jBMod.setText("jButton1");
        jBMod.setToolTipText("Buscar Anaquel(es)");
        jBMod.setNextFocusableComponent(jBNew);
        ...
        jBMod.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jBModKeyPressed(evt);
            }
        });
        jP1.add(jBMod, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 30, 20));
    ...
    /*Cuando se presiona una  tecla en la tabla de model*/
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        /*Si hay cadena vacia en el campo del código de la modea no puede continuar*/
        if(jTCod.getText().replace(" ", "").trim().compareTo("")==0)
        {
            ...
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "El código de la asociación del Modelo esta vacio.", "Campo vacio", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        /*Checa si el Modelo existe en la base de datos*/        
        try
        {
            sQ = "SELECT cod FROM model WHERE cod = '" + jTCod.getText().replace(" ", "").trim() + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            ...
            if(!rs.next())
            {
                ...
                /*Avisa al usuario*/
                JOptionPane.showMessageDialog(null, "El código del Modelo: " + jTCod.getText().replace(" ", "").trim() + " no existe.", "Registro no Existe", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd))); 
        ...
        for(int x = 0; x < jTab.getRowCount(); x++)
        {
            ...
            {
                /*Mensajea*/
                JOptionPane.showMessageDialog(null, "Ya existe este Modelo en la asociación.", "Registro existente", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        Object[] op = {"Si","No"};
        int iRes    = JOptionPane.showOptionDialog(this, "¿Seguro que quieres agregar esta asociación?", "Agregar asociación", JOptionPane.YES_NO_OPTION,  JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconDu)), op, op[0]);
        if(iRes==JOptionPane.NO_OPTION || iRes==JOptionPane.CLOSED_OPTION)
            return;
	...
	/*Obtiene la descripción del código del Modelo*/
        try
        {
            sQ = "SELECT descrip FROM model WHERE cod = '" + jTCod.getText() + "'";	
            st = con.createStatement();
            rs = st.executeQuery(sQ);
    ...
    /*Cuando se presiona uan tecla en el campo del Modelo*/
    private void jTCodKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTCodKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_DOWN)
        {
            ...
            ptovta.Busc b = new ptovta.Busc(this, jTCod.getText(), 29, jTCod, jTDescrip, null, "", null);
            b.setVisible(true);
        }
    ...
    /*Cuando se tipea una tecla en el campo del Modelo*/
    ...
    /*Cuando se presioan el botón de búscar Modelo*/
    private void jBModKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBModKeyPressed

        //Llama a la función escalable
        vKeyPreEsc(evt);

    }//GEN-LAST:event_jBModKeyPressed
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        prods.sMods = new String[jTab.getRowCount()];
        
        /*Recorre toda la tabla de asociaciones y ve creando nuevamente el arreglo*/
        for(int x = 0; x < jTab.getRowCount(); x++)       
            prods.sMods[x] = jTab.getValueAt(x, 1).toString();        
