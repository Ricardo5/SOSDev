...
public class TipsPags extends javax.swing.JFrame 
{
    ...
    private void vCargPags()
    {
        ...
        try
        {
            sQ = "SELECT cod, descrip FROM pags";
            st = con.createStatement();
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        {
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "No has seleccionado un pago de la lista para borrar.", "Borrar Pago", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        Object[] op = {"Si","No"};
        int iRes    = JOptionPane.showOptionDialog(this, "¿Seguro que quiere borrar el(los) pago(s)?", "Borrar Pago", JOptionPane.YES_NO_OPTION,  JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconDu)), op, op[0]);
        ...
        for(int x = iSel.length - 1; x >= 0; x--)
        {
            ...
            try 
            {                
                sQ = "DELETE FROM pags WHERE cod = '" + jTab.getValueAt(iSel[x], 1).toString().trim() + "'";                    
                st = con.createStatement();
                st.executeUpdate(sQ);
             }
             catch(SQLException expnSQL) 
        ...
        /*Mensajea de éxito*/
        JOptionPane.showMessageDialog(null, "Tipo(s) de pago(s) borrado(s) con éxito.", "Tipos de Pagos", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd))); 
    ...
    /*Cuando se presiona una tecla en el campo de edición de pago*/
    ...
    /*Cuando se gana el foco del teclado en el campo de edición de pago*/
    ...
    /*Cuando se presiona una tecla en el campo de descripción de pago*/
    ...
    /*Cuando se presiona una  tecla en la tabla de pags*/
    ...
    /*Cuando se gana el foco del teclado en el campo de edición de texto de descripción de pago*/
    ...
    /*Cuando se pierde el foco del teclado en el campo de descripción del pago*/
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        if(jTCod.getText().replace(" ", "").trim().compareTo("")==0)
        {
            ...
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "El código del pago esta vacio.", "Campo vacio", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        if(jTDescrip.getText().compareTo("")==0)
        {
            ...
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "El campo de descripción de pago esta vacio.", "Campo vacio", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        try
        {
            sQ = "SELECT cod FROM pags WHERE cod = '" + jTCod.getText().replace(" ", "").trim() + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
        ...
        try 
        {            
            sQ = "INSERT INTO pags(cod,                                                                                         descrip,                                                             falt,         estac,                                        sucu,                                         nocaj) " + 
    ...
    /*Cuando se tipea una tecla en el campo de código de pago*/
    ...
    private void jBBuscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscActionPerformed
        ...
        try
        {                  
            sQ = "SELECT * FROM pags WHERE cod LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR descrip LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR falt LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR fmod LIKE('%" + jTBusc.getText().replace(" ", "%") + "%')";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            /*Si hay datos*/
            while(rs.next())
