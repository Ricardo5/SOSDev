...
/*Clase para asociar las compatibilidades al producto*/
public class ProdCompa extends javax.swing.JFrame 
{
    ...
    public ProdCompa(Prods pro) 
    {
        ...
        this.setTitle("Compatibilidades, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
        ...
        /*Carga las compatibilidades pasadas en el arreglo*/
        vCarg();
    ...
    /*Obtén las compatbilidades pasadas en el arrelgo y cargalos en la tabla*/
    private void vCarg()
    {        
        /*Si no hay datos entonces regresa*/
        if(prods.sCompa==null)
            return;
        ...
        {            
            ...
            try
            {
                ...
                {
                    /*Agregalo a la tabla*/
                    Object nu[]         = {iContFi, sProd, rs.getString("descrip")};
                    te.addRow(nu);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPATIBILIDADES ");
        ...
        jBProd.setNextFocusableComponent(jBNew);
        ...
        jP1.add(jBProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 30, 20));
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        if(jTCod.getText().replace(" ", "").trim().compareTo("")==0)
        {
            ...
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "El código de la compatibilidad esta vacio.", "Campo vacio", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        int iRes    = Star.iExistProd(con, jTCod.getText().replace(" ", "").trim());
        ...
        if(iRes==0)
        {
            ...
            /*Avisa al usuario*/
            JOptionPane.showMessageDialog(null, "El código del Producto: " + jTCod.getText().replace(" ", "").trim() + " no existe.", "Registro no existe", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd))); 
        ...
        Object[] op = {"Si","No"};
        iRes        = JOptionPane.showOptionDialog(this, "¿Seguro que quieres agregar esta compatibilidad?", "Agregar compatibilidad", JOptionPane.YES_NO_OPTION,  JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconDu)), op, op[0]);
        if(iRes==JOptionPane.NO_OPTION || iRes==JOptionPane.CLOSED_OPTION)
            return;
	...
	/*Obtiene la descripción del código del producto*/
        try
        {
            sQ = "SELECT descrip FROM prods WHERE prod = '" + jTCod.getText() + "' LIMIT 1";	
            st = con.createStatement();
            rs = st.executeQuery(sQ);
    ...
    private void jTCodKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTCodKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_DOWN)
        {
            ...
            ptovta.Busc b = new ptovta.Busc(this, jTCod.getText(), 2, jTCod, jTDescrip, null, "", null);
            b.setVisible(true);
        }
        ...
        else if(evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_B)
        {
            ...
            ptovta.BuscAvan v = new ptovta.BuscAvan(this, jTCod, jTDescrip, null, null);
            v.setVisible(true);
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        prods.sCompa = new String[jTab.getRowCount()];
        
        /*Recorre toda la tabla de asociaciones y ve creando nuevamente el arreglo*/
        for(int x = 0; x < jTab.getRowCount(); x++)       
            prods.sCompa[x] = jTab.getValueAt(x, 1).toString();        
