...
/*Clase para asociar mas números de parte al producto*/
public class ProdPart extends javax.swing.JFrame 
{
    ...
    public ProdPart(Prods pro) 
    {
        ...
        this.setTitle("Asociaciones números de parte, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
        ...
        /*Carga los números de parte pasadas en el arreglo*/
        vCarg();
    ...
    /*Obtén los números de parte pasados en el arrelgo y cargalos en la tabla*/
    private void vCarg()
    {
        /*Si no hay datos entonces regresa*/
        if(prods.sParts==null)
            return;
        ...
        for(String sPart: prods.sParts)
        {
            /*Agregalo a la tabla*/
            Object nu[]         = {iContFi, sPart};
            te.addRow(nu);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ASOCIACIONES NÚMEROS DE PARTE");
        ...
        jBSal.setNextFocusableComponent(jTNum);
        ...
        jP1.add(jBNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 90, 20));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("*No.Parte:");
        ...
        jTNum.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 255)));
        jTNum.setNextFocusableComponent(jBNew);
        ...
        jP1.add(jTNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 250, 20));
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        {
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "No has seleccionado un número de parte de la lista para borrar.", "Borrar No. Parte", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        Object[] op = {"Si","No"};
        int iRes    = JOptionPane.showOptionDialog(this, "¿Seguro que quiere borrar el(los) No.Parte(s)?", "Borrar No.Parte(s)", JOptionPane.YES_NO_OPTION,  JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconDu)), op, op[0]);
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        /*Si hay cadena vacia en el campo del número de parte no puede continuar*/
        if(jTNum.getText().replace(" ", "").trim().compareTo("")==0)
        {
            /*Coloca el borde rojo*/                               
            jTNum.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.RED));
            
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "El No.Parte esta vacio.", "Campo vacio", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        {
            /*Si el número de parte ya esta en la tabla entonces*/
            if(jTab.getValueAt(x, 1).toString().compareTo(jTNum.getText())==0)
            {
                /*Mensajea*/
                JOptionPane.showMessageDialog(null, "Ya existe este No.Parte en la asociación.", "Registro existente", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        Object[] op = {"Si","No"};
        int iRes    = JOptionPane.showOptionDialog(this, "¿Seguro que quieres agregar este No.Parte?", "Agregar No.Parte", JOptionPane.YES_NO_OPTION,  JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconDu)), op, op[0]);
        if(iRes==JOptionPane.NO_OPTION || iRes==JOptionPane.CLOSED_OPTION)
            return;
        
        /*Agrega el registro en la tabla*/
        DefaultTableModel te    = (DefaultTableModel)jTab.getModel();
        Object nu[]             = {iContFi, jTNum.getText().replace(" ", "").trim()};
        te.addRow(nu);
    ...
    private void jTNumFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTNumFocusGained
        ...
        jTNum.setSelectionStart(0);jTNum.setSelectionEnd(jTNum.getText().length());
    ...
    private void jTNumFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTNumFocusLost
        ...
        if(jTNum.getText().compareTo("")!=0)
            jTNum.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,255)));
        
        /*Coloca el caret en la posiciòn 0*/
        jTNum.setCaretPosition(0);
    ...
    private void jTNumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNumKeyPressed
        ...
        /*Función escalable para controlar la pulsación*/
        vKeyPreEsc(evt);
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        /*Reinicia el arreglo de números de parte*/
        prods.sParts = new String[jTab.getRowCount()];
        
        /*Recorre toda la tabla y ve creando nuevamente el arreglo*/
        for(int x = 0; x < jTab.getRowCount(); x++)       
            prods.sParts[x] = jTab.getValueAt(x, 1).toString();        
