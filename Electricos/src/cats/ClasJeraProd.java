...
public class ClasJeraProd extends javax.swing.JFrame 
{
    ...
    {                
        ...
        this.setTitle("Clasificaciones Productos Jerárquico, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void vCargNod()
    {
        ...
        try
        {
            sQ = "SELECT rut, clas FROM clasjeraprod";
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        try
        {
            sQ = "SELECT clasjera FROM prods WHERE clasjera = '" + sRut + "'";	
            st = con.createStatement();
            rs = st.executeQuery(sQ);
        ...
        try 
        {                
            sQ = "DELETE FROM clasjeraprod WHERE rut LIKE('" + sRut + "%')";                    
            st = con.createStatement();
            st.executeUpdate(sQ);
         }
         catch(SQLException expnSQL) 
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        try 
        {                
            sQ = "INSERT INTO clasjeraprod(  clas,                                              rut,                                                                                            estac,                                       sucu,                                    nocaj) " + 
