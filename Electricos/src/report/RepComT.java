...
public class RepComT extends javax.swing.JFrame 
{
    ...
    public RepComT() 
    {
        ...
        this.setTitle("Reporte compras, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void initComponents() {
        ...
        jP1.add(jTProv, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 250, 20));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Proveedor:");
        jP1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, 170, -1));
        ...
        jCTFech.setNextFocusableComponent(jCNot);
        ...
        jP1.add(jCTFech, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 130, -1));
        ...
        jP1.add(jBBusc, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 190, 30, 20));
        ...
        jP1.add(jCDevP, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, -1, -1));
        ...
        jP1.add(jCCa, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, -1, -1));
        ...
        jP1.add(jCDev, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, -1, -1));
        ...
        jP1.add(jLAyu, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, 110, 30));

        jComTip.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Encabezados", "Archivos anexados" }));
        ...
        jP1.add(jComTip, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 180, -1));
        ...
        jCDesglo.setNextFocusableComponent(jDateDe);
        ...
        jP1.add(jCDesglo, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 90, -1));

        jBSelT.setBackground(new java.awt.Color(255, 255, 255));
        jBSelT.setToolTipText("Seleccionar/DeseleccionarTodos los Estados de Compra");
        ...
        jCNot.setText("N.C.");
        jCNot.setToolTipText("Nota de crédito");
        jCNot.setNextFocusableComponent(jCDesglo);
        jCNot.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCNotKeyPressed(evt);
            }
        });
        jP1.add(jCNot, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 70, 60, -1));
        ...
        jP1.add(jCPE, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, -1, -1));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jP1, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jBAbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAbrActionPerformed
        ...
        if(!jCCo.isSelected() && !jCCa.isSelected() && !jCDev.isSelected() && !jCDevP.isSelected() && !jCPE.isSelected())
        {
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "Selecciona por lo menos un estado de compra.", "Reporte", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd))); 
        ...
        {
            /*Si desglozado esta marcado entonces*/
            if(jCDesglo.isSelected())
                sTip        = "/jasreport/rptComTDet.jrxml";
            else
                sTip        = "/jasreport/rptComT.jrxml";
        }
        else if(jComTip.getSelectedItem().toString().compareTo("Archivos anexados")==0)
            sTip        = "/jasreport/rptArchIndex.jrxml";
        
        /*Obtiene los tipos de compras que tiene que mostrar*/
        String sTipCom  = "";
        if(jCCo.isSelected())
            sTipCom += "'CO',";
        if(jCCa.isSelected())
        ...
        /*Determina los tipos de documentos que va a mostrar*/        
        String sComNot  = "'COMP',";
        if(jCNot.isSelected())
            sComNot += "'NOT',";
        
        /*Quita la última coma del tipo de compra*/
        sComNot = sComNot.substring(0, sComNot.length() - 1);
        ...
        final String sComNotFi       = sComNot;
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    pa.put("F_D",       sFDeFi);
                    pa.put("F_A",       sFAFi);
                    pa.put("TIPDOC",    sComNotFi);
                    pa.put("TIPESTAD",  sTipComFi);

                    /*Compila el reporte y muestralo maximizado*/
                    JasperReport ja = JasperCompileManager.compileReport(getClass().getResourceAsStream(sTipFi));
    ...
    /*Cuando se presiona una tecla en el check de la nota de crédito*/
    ...
    /*Cuando sucede una acción en el combo de tipo de reporte*/
    private void jComTipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComTipActionPerformed
        
        /*Habilita los controles podrían no aplicar*/
        jCDesglo.setEnabled(true);
        jCDesglo.setFocusable(true);
            
        /*Si el reporte es de archivos indexados entonces*/
        if(jComTip.getSelectedItem().toString().trim().compareTo("Archivos anexados")==0)
        {
            /*Deshabilita los controles que no aplican para este reporte*/
