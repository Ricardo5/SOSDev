...
public class RepPrevCom extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jTBuscEsta = new javax.swing.JButton();
        ...
        jP1.add(jBBusc, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 380, 30, 20));
        ...
        jTEsta.setNextFocusableComponent(jTBuscEsta);
        ...
        jP1.add(jTEsta, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 90, 20));

        jTBuscEsta.setBackground(new java.awt.Color(255, 255, 255));
        jTBuscEsta.setText("...");
        jTBuscEsta.setToolTipText("Buscar Usuario(s)");
        jTBuscEsta.setNextFocusableComponent(jTProd);
        jTBuscEsta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jTBuscEstaMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jTBuscEstaMouseExited(evt);
            }
        });
        jTBuscEsta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTBuscEstaActionPerformed(evt);
            }
        });
        jTBuscEsta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTBuscEstaKeyPressed(evt);
            }
        });
        jP1.add(jTBuscEsta, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 30, 20));
    ...
    /*Cuando se presiona una tecla en el campo de emps*/
    ...
    private void jBAbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAbrActionPerformed
        ...
        if(iRes==0 && jTMed.getText().compareTo("")!=0)
        {
            ...
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "La medida: " + jTMed.getText() + " no existe.", "Reporte", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        //Si el no impuesto existe entonces        
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    v.setTitle("Reporte Cotizaciones");
    ...
    /*Cuando se presiona el boton de búscar estac*/        
    private void jTBuscEstaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTBuscEstaActionPerformed

        /*Llama al otro formulario de búsqueda y pasale lo que el usuario escribió*/
        Busc b = new Busc(this, jTEsta.getText(), 4, jTEsta, null, null, "", null);
        b.setVisible(true);

    }//GEN-LAST:event_jTBuscEstaActionPerformed

    
    /*Cuando se presiona una tecla en el botón de bùscar usuario*/
    private void jTBuscEstaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscEstaKeyPressed

        //Llama a la función escalable
        vKeyPreEsc(evt);

    }//GEN-LAST:event_jTBuscEstaKeyPressed
    ...
    /*Cuando se pierde el foco del teclado en el campo de la ubicación*/
    ...
    /*Cuando se pierde el foco del teclado en el campo de medida*/
    ...
    private void jTBuscEstaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTBuscEstaMouseEntered
        
        /*Cambia el color del fondo del botón*/
        jTBuscEsta.setBackground(Star.colBot);
        
    }//GEN-LAST:event_jTBuscEstaMouseEntered
    ...
    private void jTBuscEstaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTBuscEstaMouseExited
        
        /*Cambia el color del fondo del botón al original*/
        jTBuscEsta.setBackground(colOri);
        
    }//GEN-LAST:event_jTBuscEstaMouseExited
    ...
    private javax.swing.JButton jTBuscEsta;
