...
/*Clase para controlar el reporteador del flujo*/
public class RepFluj extends javax.swing.JFrame 
{
    ...
    public RepFluj()
    {
        ...
        this.setTitle("Reporte Flujo, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void initComponents() {
        ...
        jCTFechas.setNextFocusableComponent(jCE);
        ...
        jCS.setSelected(true);
        jCS.setText("Salida");
        jCS.setToolTipText("Confirmados");
        jCS.setNextFocusableComponent(jTEsta);
        jCS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCSKeyPressed(evt);
            }
        });
        jP1.add(jCS, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 70, -1));

        jCE.setBackground(new java.awt.Color(255, 255, 255));
        jCE.setSelected(true);
        jCE.setText("Entrada");
        jCE.setToolTipText("Pendientes");
        jCE.setNextFocusableComponent(jCS);
        jCE.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCEKeyPressed(evt);
            }
        });
        jP1.add(jCE, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 80, -1));
    ...
    private void jBAbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAbrActionPerformed
        ...
        if(!jCS.isSelected() && !jCE.isSelected())
        {
            /*Mensajea*/
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                {                    
                    ...
                    JasperReport ja     = JasperCompileManager.compileReport(getClass().getResourceAsStream("/jasreport/rptFluj.jrxml"));
    ...
    private void jCEKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCEKeyPressed
        
        //Llama a la función escalable
        vKeyPreEsc(evt);
        
    }//GEN-LAST:event_jCEKeyPressed

    
    /*Cuando se presiona una tecla en el checkbox de salida*/
    private void jCSKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCSKeyPressed
        
        //Llama a la función escalable
        vKeyPreEsc(evt);
        
    }//GEN-LAST:event_jCSKeyPressed
    ...
    private void jBSelTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSelTActionPerformed
        ...
        if(bSel)
        {
            ...
            jCE.setSelected(false);
            jCS.setSelected(false);            
    ...
    private javax.swing.JCheckBox jCE;
