...
public class RepLogCor extends javax.swing.JFrame 
{
    ...
    public RepLogCor() 
    {
        ...
        this.setTitle("Reporte log correos, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void initComponents() {
        ...
        jP1.add(jDateDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 140, 20));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("A:");
        jP1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 150, 20));
        ...
        jP1.add(jDateA, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 140, 20));
        ...
        jP1.add(jCTFech, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 130, 20));
        ...
        jLabel6.setText("De:");
        jP1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 130, 20));
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    JasperReport ja = JasperCompileManager.compileReport(getClass().getResourceAsStream("/jasreport/rptLogCo.jrxml"));
                    ...
                    v.setTitle("Reporte Log correos");
