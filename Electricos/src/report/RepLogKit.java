...
/*Clase para controlar el reporteador del log de kits*/
public class RepLogKit extends javax.swing.JFrame 
{
    ...
    public RepLogKit()
    {
        ...
        this.setTitle("Reporte log kits, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void initComponents() {
        ...
        jTCaj.setNextFocusableComponent(jTKit);
        ...
        jTKit.setNextFocusableComponent(jBKit);
        ...
        jP1.add(jTKit, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 100, 20));

        jBKit.setBackground(new java.awt.Color(255, 255, 255));
        jBKit.setText("...");
        jBKit.setToolTipText("Buscar Kit(s)");
        jBKit.setNextFocusableComponent(jCTFech);
        jBKit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jBKitMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jBKitMouseExited(evt);
            }
        });
        jBKit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBKitActionPerformed(evt);
            }
        });
        jBKit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jBKitKeyPressed(evt);
            }
        });
        jP1.add(jBKit, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 30, 20));
    ...
    private void jBAbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAbrActionPerformed
        ...
        try
        {
            sQ = "SELECT codkit FROM kits WHERE codkit = '" + jTKit.getText().replace(" ", "") + "'";                       
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            /*Si no hay datos entonces no existe*/
            if(!rs.next()&& jTKit.getText().replace(" ", "").compareTo("")!=0)
            {
                //Cierra la base de datos
                if(Star.iCierrBas(con)==-1)
                    return;
                ...
                /*Coloca el borde rojo*/                               
                jTKit.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.RED));
                
                /*Mensajea*/
                JOptionPane.showMessageDialog(null, "El kit: " + jTKit.getText().replace(" ", "") + " no existe.", "No existe", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd)));
        ...
        final String sKitFi         = jTKit.getText().replace(" ", "");              
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                {                    
                    ...
                    JasperReport ja     = JasperCompileManager.compileReport(getClass().getResourceAsStream("/jasreport/rptLogKit.jrxml"));
    ...
    /*Cuando se presiona el boton de buscar usuario*/
    ...
    /*Cuando se gana el foco del teclado en el campo del código del kit*/
    ...
    private void jTKitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTKitKeyPressed
        ...
        {
            /*Llama al otro formulario de búsqueda y pasale lo que el usuario escribió*/
            Busc b = new Busc(this, jTKit.getText(), 26, jTKit, null, null, "", null);
            b.setVisible(true);
        }
    ...
    private void jTKitKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTKitKeyTyped

        /*Si el carácter introducido es minúscula entonces colocalo en el campo con mayúsculas*/
        if(Character.isLowerCase(evt.getKeyChar()))       
            evt.setKeyChar(Character.toUpperCase(evt.getKeyChar()));                              
        
    }//GEN-LAST:event_jTKitKeyTyped

    
    /*Cuando se presiona el botón de búscar kit*/
    private void jBKitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBKitActionPerformed
    ...
    }//GEN-LAST:event_jBKitActionPerformed

    
    /*Cuando se presiona una tecla en el botón de búscar producto*/
    private void jBKitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBKitKeyPressed

        //Llama a la función escalable
        vKeyPreEsc(evt);

    }//GEN-LAST:event_jBKitKeyPressed
    ...
    /*Cuando el mouse entra en el botón específico*/
    private void jBKitMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBKitMouseEntered
        
        /*Cambia el color del fondo del botón*/
        jBKit.setBackground(Star.colBot);
        
    }//GEN-LAST:event_jBKitMouseEntered
    ...
    /*Cuando el mouse sale del botón específico*/
    private void jBKitMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBKitMouseExited
        
        /*Cambia el color del fondo del botón al original*/
        jBKit.setBackground(colOri);
        
    }//GEN-LAST:event_jBKitMouseExited
    ...
    private javax.swing.JButton jBKit;
