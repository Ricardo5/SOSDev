...
/*Clase para controlar el reporteador de los respaldos*/
public class RepResp extends javax.swing.JFrame 
{
    ...
    public RepResp()
    {
        ...
        this.setTitle("Reporte respaldos, Usuario: <" + Login.sUsrG + "> " + Login.sFLog);        
    ...
    private void initComponents() {
        ...
        jCExp = new javax.swing.JCheckBox();
        ...
        jCTFechas.setNextFocusableComponent(jCImp);
        ...
        jCExp.setBackground(new java.awt.Color(255, 255, 255));
        jCExp.setSelected(true);
        jCExp.setText("Exportar");
        jCExp.setToolTipText("Confirmados");
        jCExp.setNextFocusableComponent(jTUsr);
        jCExp.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCExpKeyPressed(evt);
            }
        });
        jP1.add(jCExp, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 80, -1));

        jCImp.setBackground(new java.awt.Color(255, 255, 255));
        jCImp.setSelected(true);
        jCImp.setText("Importar");
        jCImp.setToolTipText("Pendientes");
        jCImp.setNextFocusableComponent(jCExp);
        jCImp.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCImpKeyPressed(evt);
            }
        });
        jP1.add(jCImp, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 80, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Usuario:");
        jP1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 130, -1));

        jTUsr.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 255), 1, true));
        jTUsr.setNextFocusableComponent(jBBuscEsta);
        ...
        jP1.add(jTUsr, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 90, 20));
        ...
        jTCaj.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 255), 1, true));
        ...
        jTSucu.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 255), 1, true));
        ...
        jBSelT.setToolTipText("Seleccionar/Deseleccionar el tipo de Reporte");
        jBSelT.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jBSelT.setNextFocusableComponent(jTUsr);
    ...
    private void jBAbrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAbrActionPerformed
        ...
        /*Si no esta seleccionado por lo menos importar o exportar entonces*/
        if(!jCExp.isSelected() && !jCImp.isSelected())
        {
            /*Mensajea*/
            JOptionPane.showMessageDialog(null, "Selecciona por lo menos importar o exportar.", "Reporte", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource(Star.sRutIconAd))); 
        ...
        /*Determina si mostrará las importaciones*/
        String sEst      = "1";
        if(jCImp.isSelected())
            sEst         = "0";
        
        /*Determina si mostrará las exportaciones*/        
        if(jCExp.isSelected())
            sEst         = "1";
        
        /*Determina si mostrarán los importaciones y las exportaciones*/        
        if(jCExp.isSelected() && jCImp.isSelected())
            sEst         = "2";
        ...
        (new Thread()
        {
            ...
            public void run()
            {
                ...
                {                    
                    ...
                    JasperReport ja     = JasperCompileManager.compileReport(getClass().getResourceAsStream("/jasreport/rptResp.jrxml"));
                    ...
                    v.setTitle("Reporte de Respaldos");
    ...
    /*Cuando se presiona una tecla en el checkbox de importar*/
    ...
    /*Cuando se presiona una tecla en el checkbox de exportar*/
    private void jCExpKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCExpKeyPressed
        
        //Llama a la función escalable
        vKeyPreEsc(evt);
        
    }//GEN-LAST:event_jCExpKeyPressed
    ...
    /*Cuando se presiona una tecla en el botón de seleccionar todos los check*/
    ...
    private javax.swing.JCheckBox jCExp;
